...
https://img.shields.io/badge/BattleScript-0.0.1-blue
https://img.shields.io/badge/Node.js-16%252B-green
https://img.shields.io/badge/WebSocket-Real--time-orange
...
Нажмите "Быстрый старт" для поиска противника

Игра начнется автоматически при нахождении соперника
...
Типы карт
Существа - Остаются на поле, могут атаковать

Заклинания - Разовые эффекты
...
🤝 Вклад в проект
Правила разработки
Используйте формат коммитов: [тип]: описание
...
🔗 Ссылки
Демо (после запуска сервера)

Issues

Changelog

BattleScript © 2024 - Тактическая карточная дуэль следующего поколения
